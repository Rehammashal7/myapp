...
const COLORS =theme.DARK_COLORS;
const { width } = Dimensions.get("screen");
const { height } = Dimensions.get("screen");

const cardwidth = width / 2;
let iconcolor;
const ProductsListMen = ({ navigation ,route}) => {
  ...
  const handleProductPress = (product) => {
    navigation.navigate("MenDetails", { product,COLORS:COLORS });
  };
...
const MenDetails = ({ route, navigation }) => {
...
export { ProductsListMen, MenDetails };
