...
const AddReviewWoman = ({ route, navigation }) => {
...
const addReview = async () => {
    ...
    try {
        ...
        await updateDoc(productRef, {
            reviews: arrayUnion({ rating: parseInt(rating), comment, username, date: currentDate,like, disLike}),
        });
