...
const Profile = ({ navigation }) => {
  ...
  //     // const storageRef = ref(storage, `${currentUser.uid}/profilePicture.png`);
      ...
      {mode === "view" && (
        <>
          ...
          <View style={styles.field}>
            ...
            <Text style={styles.value2}>{birthDate}</Text>
          </View>
          ...
          <TouchableOpacity onPress={handleMyOrderPress}>
            <View style={styles.field}>
              ...
              <Text style={styles.value2}>{order}</Text>
            </View>
          </TouchableOpacity>

          <View style={styles.containerButton}>
            <TouchableOpacity style={styles.logoutEdit} onPress={handleEdit}>
