...
const AddProductForm = () => {
  ...
  const handletypeChange = (text) => {
    const typeArray = text.split(',').map(type => type.trim());
    setType(typeArray);
  };
      ...
      <View style={styles.container}>
        <View style={styles.form}>
          ...
          <View style={styles.inputContainer}>
            ...
            <TextInput style={styles.input} value={sizes.join(', ')} onChangeText={handleSizeChange} />
          </View>
          <View style={styles.inputContainer}>
          ...
          <View style={styles.inputContainer}>
            ...
            <TextInput style={styles.input} value={colors} onChangeText={handleColorInput} />
          </View>
          <View style={styles.inputContainer}>
            <Text style={styles.label}>Offer:</Text>
            <TextInput style={styles.input} value={offer} onChangeText={setOffer} keyboardType="numeric" />
          </View>
          <View style={styles.inputContainer}>
